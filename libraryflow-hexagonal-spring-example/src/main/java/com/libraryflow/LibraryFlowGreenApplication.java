...
/**
 * Startpunkt der hexagonalen LibraryFlow-Anwendung (Green).
 *
...
@EnableScheduling
public class LibraryFlowGreenApplication {

    public static void main(String[] args) {
        SpringApplication.run(LibraryFlowGreenApplication.class, args);
    }
}
