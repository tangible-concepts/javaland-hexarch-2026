...
public class Loan {
    ...
    private Loan(LoanId id, BookId bookId, UserId userId, LocalDate borrowDate, LocalDate dueDate, boolean returned) {
        this.id = id;
        this.bookId = bookId;
        this.userId = userId;
     ...
     */
    public static Loan reconstitute(LoanId id, BookId bookId, UserId userId,
